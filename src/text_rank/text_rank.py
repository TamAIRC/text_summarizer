# from preprocessing import process_text, correct
...
from src.text_rank.preprocessing import process_text, correct
...
def summarize_text(text, percent):
    ...
    for i, sentence in enumerate(summary_sentences):
        corrected_sentence = correct(' '.join(sentence).replace('_', ' '))
        summary_sentences[i] = corrected_sentence.split()
...
# """
# # Example usage:
# summary = summarize_text(your_text_here, 30)  
# print(summary)
