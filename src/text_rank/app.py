...
from text_rank import textrank, summarize_text
...
def main():
    ...
    num_sen = st.number_input("Số phần trăm: ", min_value=1, max_value=100, value=20)

    # Nút nhấn để bắt đầu tóm tắt
    if st.button("Tóm tắt"):
        # Xử lý và tóm tắt văn bản 1
        start_time = time.time()
        summary_1 = summarize_text(text_input_1, num_sen)
        end_time = time.time()
